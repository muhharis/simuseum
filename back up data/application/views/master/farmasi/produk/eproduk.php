                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>produk/simpan" method="POST" onsubmit="return cekform();">
                                    <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="kode_barang" name="kode_barang" value="<?php echo $kode_barang; ?>" minlength="2" type="text" readonly="readonly" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="nm_barang" class="control-label col-lg-2">Nama Produk</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="nm_barang" name="nm_barang" value="<?php echo $nm_barang; ?>" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="spesifikasi" name="spesifikasi" value="<?php echo $spesifikasi; ?>" minlength="2" type="text" required />
                                          </div>
                                      </div>
