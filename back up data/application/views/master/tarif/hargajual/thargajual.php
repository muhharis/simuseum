                                  ...
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>hargajual/simpan" method="POST" onsubmit="return cekform();">
                                    ...
                                    <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="harga_jual" name="harga_jual" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="diskon_persen" name="diskon_persen" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="diskon_rupiah" name="diskon_rupiah" minlength="2" type="text" required />
                                          </div>
                                      </div>
