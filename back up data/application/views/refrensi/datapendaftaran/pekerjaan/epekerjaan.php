                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>pekerjaan/simpan" method="POST">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="id_pekerjaan" name="id_pekerjaan" minlength="2" type="text" value="<?php echo $id_pekerjaan; ?>" required readonly="readonly"/>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="pekerjaan" class="control-label col-lg-2">Pekerjaan</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="pekerjaan" name="pekerjaan" value="<?php echo $pekerjaan; ?>"minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
