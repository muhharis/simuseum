                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>statuskawin/simpan" method="POST">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="id_sk" name="id_sk" value="<?php echo $id_sk; ?>" minlength="2" type="text" required readonly="readonly" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="statuskawin" class="control-label col-lg-2">Nama Status</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="status_kawin" name="status_kawin" value="<?php echo $status_kawin; ?>" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
