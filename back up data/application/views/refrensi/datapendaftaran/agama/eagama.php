                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>agama/simpan" method="POST">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="agama_id" name="agama_id" minlength="2" type="text" value="<?php echo $agama_id; ?>" required readonly="readonly" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="agama" class="control-label col-lg-2">Nama Agama</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="agama" name="agama" value="<?php echo $agama; ?>" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
