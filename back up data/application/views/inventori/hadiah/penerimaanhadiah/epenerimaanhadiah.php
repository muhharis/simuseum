                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>penerimaanhadiah/simpan" method="POST">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="kode_penerimaan_hadiah" name="kode_penerimaan_hadiah" value="<?php echo $kode_penerimaan_hadiah; ?>" minlength="2" type="text" readonly="readonly"  required/> 
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                             <input name="jumlah" id="jumlah" class="form-control" type="text" style="width:537px;" value="<?php echo $jumlah; ?>" required>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                             <input class="form-control" id="ket" name="ket"  minlength="2" type="text" value="<?php echo $ket; ?>" required />
                                          </div>
                                      </div>
                                      <div class="form-group">
