                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>penerimaanobat/simpan" method="POST">
                                      <div class="form-group ">
                                          <label for="bank_id" class="control-label col-lg-2">No Penerimaan Obat/Produk</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="kode_penerimaan" name="kode_penerimaan"  minlength="2" type="text"   required/> 
                                          </div>
                                      </div>
