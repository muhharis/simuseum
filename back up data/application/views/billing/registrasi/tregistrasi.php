                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>registrasi/simpan" method="POST">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="no_registrasi" name="no_registrasi" value="<?= $kodeunik2; ?>"  minlength="2" type="text" readonly="readonly"  required/> 
                                          </div>
                                      </div>
                                      <div class="form-group">
                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="form-group ">
                                          <label for="tgl_reg" class="control-label col-lg-2">Tanggal Registrasi</label>
                                          <div class="form-inline">
                                            <div class="col-lg-10">
                                              <input type="text" class="form-control" name="tgl_reg"  id="tgl_awal" required>
                                            </div>
                                          </div>
                                      </div>
                                      <div class="form-group ">
