                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>penerimaanhadiah/simpan" method="POST">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="no_penerimaan_hadiah" value="<?= $kodeunik2; ?>" name="no_penerimaan_hadiah"  minlength="2" type="text" readonly required/> 
                                          </div>
                                      </div>
...
<!----------------->
                                      ...
                                      <!--<div class="form-group ">
                                          ...
                                          <div class="form-inline">
                                            <div class="col-lg-10">
                                             <input type="text" class="form-control" name="tanggal" style="width:266px;" id="tgl_awal" value="<?php  $tgl=date('Y-m-d'); echo $tgl; ?>" readonly="readonly" required>
                                              <input type="time" class="form-control" name="jam" id="jam" style=" width:266px;" required/>
                                            </div>
                                          </div>
                                      </div> -->
