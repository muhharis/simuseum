                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>penerimaanobat/simpan" method="POST">
                                      <div class="form-group ">
                                          <label for="no_penerimaan_obat" class="control-label col-lg-2">No Penerimaan</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="no_penerimaan_obat" name="no_penerimaan_obat" value="<?php echo $no_penerimaan_obat; ?>" minlength="2" type="text" readonly="readonly"  required/> 
                                          </div>
                                      </div>
