                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>kelaspelayanan/simpan" method="POST">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="kelas_id" name="kelas_id" minlength="2" value="<?= $kodeunik2; ?>" type="text" readonly required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="nm_kel" class="control-label col-lg-2">Nama Kelas Pelayanan</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="kelas" name="kelas" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
