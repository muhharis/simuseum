                  ...
                  <div class="col-lg-12">
                      ...
                      <section class="panel">
                          ...
                          <header class="panel-heading"><a href="<?php echo base_url(); ?>satuanbarang" class="icon-mail-reply"></a>
                              Tambah Data Satuan Barang atau Obat
                          </header>
                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>satuanbarang/simpan" method="POST">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="satuan_id" name="satuan_id" value="<?= $kodeunik2; ?>" minlength="2" type="text" readonly required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="satuan" class="control-label col-lg-2">Nama Satuan Barang atau Obat</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="satuan" name="satuan" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
