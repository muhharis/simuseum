                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>rekbank/simpan" method="POST">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="rek_id" name="rek_id" value="<?= $kodeunik2; ?>" minlength="2" type="text" readonly required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="no_rek" class="control-label col-lg-2">Nomor Rekening</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="no_rek" name="no_rek" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
