                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>bank/simpan" method="POST">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="bank_id" name="bank_id" value="<?= $kodeunik2; ?>" minlength="2" type="text" readonly required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="bank" class="control-label col-lg-2">Nama Bank</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="bank" name="bank" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
