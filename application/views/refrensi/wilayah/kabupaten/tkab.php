                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>kabupaten/simpan" method="POST">
                                      <div class="form-group ">
                                          <label for="kd_prop" class="control-label col-lg-2">Nama Propinsi</label>
                                          <div class="col-lg-10">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="kd_kab" name="kd_kab" value="<?= $kodeunik2; ?>" minlength="2" type="text" required readonly />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="nm_kab" class="control-label col-lg-2">Nama Kabupaten</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="nm_kab" name="nm_kab" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group">
