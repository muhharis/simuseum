...
<div class="row">
                  <div class="col-lg-12">
                      ...
                      <section class="panel">
                          ...
                          <header class="panel-heading"><a href="<?php echo base_url(); ?>propinsi" class="icon-mail-reply" title="Kembali"></a>
                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>propinsi/simpan" method="POST">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="kd_prop" name="kd_prop" value="<?= $kodeunik2; ?>" minlength="2" type="text" readonly required/>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="nm_prop" class="control-label col-lg-2">Nama Propinsi</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="nm_prop" name="nm_prop" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group">
