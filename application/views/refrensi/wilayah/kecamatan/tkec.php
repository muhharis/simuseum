                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>index.php/kecamatan/simpan" method="POST">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="kd_kec" name="kd_kec" minlength="2" value="<?= $kodeunik2; ?>" type="text" readonly required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="nm_kec" class="control-label col-lg-2">Nama Kecamatan</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="nm_kec" name="nm_kec" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group">
