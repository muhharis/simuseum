                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>index.php/pemasok/simpan" method="POST" onsubmit="return cekform();">
                                    <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="kode_pemasok" name="kode_pemasok" value="<?php echo $kode_pemasok; ?>" minlength="2" type="text" required readonly="readonly" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="nm_pemasok" class="control-label col-lg-2">Nama Pemasok</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="nm_pemasok" name="nm_pemasok" value="<?php echo $nm_pemasok; ?>" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="no_ktp" name="no_ktp" value="<?php echo $no_ktp; ?>" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="kota" name="kota" value="<?php echo $kota; ?>" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="telp" class="control-label col-lg-2">Nomor Telepon</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="telp" name="telp" value="<?php echo $telp; ?>" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control " id="ket" name="ket" value="<?php echo $ket; ?>" required></textarea>
                                          </div>
                                      </div>
