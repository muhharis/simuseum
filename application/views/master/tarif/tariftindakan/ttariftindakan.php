                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>tariftindakan/simpan" method="POST" onsubmit="return cekform();">
                                    <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="tarif_tindakan_id" value="<?= $kodeunik2; ?>" name="tarif_tindakan_id" minlength="2" type="text" readonly required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="tarif" name="tarif" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="disc_persen" name="disc_persen" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="disc_rupiah" name="disc_rupiah" minlength="2" type="text" required />
                                          </div>
                                      </div>
