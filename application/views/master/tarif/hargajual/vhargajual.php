...
-->
<script>
  function select_data($harga_jual_id,$kode_barang,$nm_barang,$tgl_berlaku,$harga_jual,$disc_persen,$disc_rupiah,$ket) {
    $("#harga_jual_id").val($harga_jual_id);
                      ...
                      <div class="adv-table editable-table ">
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tr class="">
                                  ...
                                  <td><a href="<?php echo base_url(); ?>hargajual/ubah/<?php echo $row->harga_jual_id; ?>">Ubah</a>
                                      | <a href="<?php echo base_url(); ?>hargajual/hapus/<?php echo $row->harga_jual_id; ?>" onclick="return confirm('Anda yakin ingin menghapus harga jual barang <?php echo $row->nm_barang; ?> ?')">Hapus</a>
                              ...
                              <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div>
                                              <input class="form-control" id="harga_jual_id" name="harga_jual_id"  minlength="2" type="text" readonly="readonly" required />
                                          </div><br>
