                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>hargajual/simpan" method="POST" onsubmit="return cekform();">
                                    ...
                                    <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" class="form-control" name="harga_jual_id" id="harga_jual_id" value="<?= $kodeunik2; ?>" readonly>
                                          </div>
                                      </div>
                                    ...
                                    <!--  <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input type="text" onkeypress="return hanyaAngka(event)" placeholder="" name="harga_jual" id="jumlah" class="form-control">
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="disc_persen" name="disc_persen" minlength="1" type="text"  onkeypress="return hanyaAngka(event)"  />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="disc_rupiah" name="disc_rupiah" minlength="1" type="text" type="text" onkeypress="return hanyaAngka(event)"  />
                                          </div>
                                      </div>
