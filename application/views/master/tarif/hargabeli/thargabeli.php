                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>hargabeli/simpan" method="POST" onsubmit="return cekform();">
                                    ...
                                    <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" class="form-control" name="harga_beli_id" value="<?= $kodeunik2; ?>" id="harga_beli_id" required readonly>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="harga_beli" name="harga_beli" minlength="2" type="text" required />
                                          </div>
                                      </div>
