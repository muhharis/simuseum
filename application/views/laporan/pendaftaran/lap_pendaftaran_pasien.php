...
<section class="panel">
                  <header class="panel-heading">
                      Data Laporan Pendaftaran Pasien
                  </header>
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                          <div class="clearfix">
                            <form action="<?php echo base_url(); ?>lap_pendaftaran_pasien/cetak_all">
                              <div class="btn-group">
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tr class="">
                                  ...
                                  <td><!--<a href="<?php //echo base_url(); ?>masterpasien/ubah/<?php //echo $row->no_rek_medik; ?>">Ubah</a>
                                      ...
                                      | --> <a href="<?php echo base_url(); ?>lap_pendaftaran_pasien/detail/<?php echo $row->no_rek_medik; ?>"><button class="btn btn-primary" title="Detail"><i class="icon-eye-open"></i>
                                  </button></a> <!--<a href="<?php// echo base_url().'masterpasien/cetak_id/'.$row->no_rek_medik;?>">cetak</a> --><!--<a data-toggle="modal" href="#myModal" onclick="select_data(
                                        '<?= $row->no_rek_medik ?>',
                                        '<?= $row->nm_pasien ?>',
                                        '<?= $row->gender ?>',
                                        '<?= $row->tmpt_lahir ?>',
