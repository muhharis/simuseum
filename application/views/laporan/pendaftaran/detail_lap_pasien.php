...
<div class="row">
                  <aside class="panel-body">
                     <section class="panel">
                          <header class="panel-heading"><a href="<?php echo base_url(); ?>lap_pendaftaran_pasien" class="icon-mail-reply"></a>
                              Kembali
                          </header>
                    </section>
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <td><br><hr><a href="<?php echo base_url().'lap_pendaftaran_pasien/cetak_id/'.$no_rek_medik;?>"><button type="button" class="btn btn-primary"><i class="icon-print"></i> Cetak Data</button></a> </td>
                          </div>
