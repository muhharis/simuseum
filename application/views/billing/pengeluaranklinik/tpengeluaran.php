                          ...
                          <div class="panel-body">
                              <div class=" form">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="pengeluaran_id" name="pengeluaran_id" value="<?= $kodeunik2; ?>" minlength="2" type="text" readonly required/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="pengeluaran" name="pengeluaran"  minlength="2" type="text" required/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="pengeluaran" class="control-label col-lg-2">Jumlah</label>
                                          <div class="col-sm-10">
                                                  <input type="text" onkeypress="return hanyaAngka(event)" placeholder="" name="jumlah" id="jumlah" class="form-control">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="form-inline">
                                            <div class="col-lg-10">
                                              <input type="text" class="form-control" name="tanggal_pengeluaran"  id="tgl_awal" required>
                                            </div>
                                          </div>
                                      </div>
