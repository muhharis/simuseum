                          ...
                          <div class="panel-body">
                              <div class=" form">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <select class="form-control" id="jenis_pengeluaran_id" name="jenis_pengeluaran_id" minlength="2" required />
                                              <option></option>
                                              <?php 
                                                  foreach($addpeng as $nama)
                                                    {
                                                      echo '<option value="'.$nama->jenis_pengeluaran_id.'">'.$nama->jenis_pengeluaran.'</option>';
                                                      }
                                              ?>
                                          </select >
                                          </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="pengeluaran" name="pengeluaran" value="<?php echo $pengeluaran; ?>" minlength="2" type="text" required/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="pengeluaran" class="control-label col-lg-2">Jumlah</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="jumlah" name="jumlah" value="<?php echo $jumlah; ?>" minlength="2" type="text" required/> 
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="form-inline">
                                            <div class="col-lg-10">
                                              <input type="text" class="form-control" name="tanggal_pengeluaran" value="<?php echo $tanggal_pengeluaran; ?>" id="tgl_awal" required>
                                            </div>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="ket" name="ket" value="<?php echo $ket; ?>"  minlength="2" type="text" required/> 
                                          </div>
                                      </div>
                                      <div class="form-group">
