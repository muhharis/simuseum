...
<div class="row">
                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>masterpasien/simpan" method="POST">
                                   <!-- <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="kode_pasien" name="kode_pasien" value="<?= $kodeunik; ?>" minlength="2" type="text" readonly="readonly"  required/> 
                                          </div>
                                      </div>-->
                                      <div class="form-group ">
                                          <label for="no_rek_medik" class="control-label col-lg-2">No Rekam Medis</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="no_rek_medik" name="no_rek_medik" value="<?= $kodeunik2; ?>"  minlength="2" type="text" readonly="readonly"  required/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="nm_pasien" class="control-label col-lg-2">Nama Pasien</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="nm_pasien" name="nm_pasien"  minlength="2" type="text"   required/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="form-inline">
                                            <div class="col-lg-10">
                                              <input type="text" class="form-control" name="tgl_lahir"  id="tgl_awal" required>
                                            </div>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="tmpt_lahir" name="tmpt_lahir"  minlength="2" type="text"   required/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="no_identitas" class="control-label col-lg-2">No KTP</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="no_identitas" name="no_identitas"  minlength="2" type="text"   required/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="no_telp" class="control-label col-lg-2">No Telepon</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="no_telp" name="no_telp"  minlength="2" type="text"   required/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="gol_darah" class="control-label col-lg-2">Golongan Darah</label>
                                          <div class="col-lg-10">
                                            <select class="form-control" id="gol_darah" name="gol_darah" minlength="2" required />
                                              <option></option>
                                              <option>A</option>
                                              <option>B</option>
                                              <option>AB</option>
             ...
             <!-- <?php
        //echo form_open_multipart('masterpasien/do_upload');
        ?>
