                          ...
                          <div class="panel-body">
                              <div class=" form">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="kode_pelayanan" name="kode_pelayanan"  minlength="2" type="text" value="<?php echo $kode_pelayanan;  ?>"readonly   required/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
