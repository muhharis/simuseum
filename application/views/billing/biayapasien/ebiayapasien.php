                  ...
                  <div class="col-lg-12">
                      ...
                      <section class="panel">
                          ...
                          <header class="panel-heading"><a href="<?php echo base_url(); ?>biaya_pasien" class="icon-mail-reply"></a>
                              Tambah Data Biaya Administrasi Pembayaran Pasien
                          </header>
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" action="<?php echo base_url(); ?>biaya_pasien/simpan" method="POST">
                                      <div class="form-group ">
                                          <label for="kode_kwitansi" class="control-label col-lg-2">Kode Kwitansi</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="kode_kwitansi" name="kode_kwitansi" value="<?php echo $kode_kwitansi; ?>"  minlength="2" type="text" readonly required/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          ...
                                          <div class="form-inline">
                                            <div class="col-lg-10">
                                             <input type="text" class="form-control" name="tgl" style="width:266px;" id="tgl_awal" value="<?php  $tgl=date('Y-m-d'); echo $tgl; ?>" readonly="readonly" required>
                                              <input type="text" class="form-control" name="jam" id="jam" style=" width:266px;" required/>
                                            </div>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="form-inline">
                                            <div class="col-lg-10">
                                              <input type="text" class="form-control" name="no_registrasi" value="<?php echo $no_registrasi; ?>"  id="no_registrasi" required>
                                            </div>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            <input class="form-control" id="b_periksa" name="b_periksa" value="<?php echo $b_periksa; ?>"  minlength="2" type="text"   required onkeyup="sum();" /> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="b_obat" class="control-label col-lg-2">Biaya Obat</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="b_obat" name="b_obat" value="<?php echo $b_obat; ?>"  minlength="2" type="text" required onkeyup="sum();"/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="total_bayar" class="control-label col-lg-2">Total Bayar</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="total_bayar" value="<?php echo $total_bayar; ?>" name="total_bayar" minlength="2" type="text"   required onkeyup="das();"/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="tunai" class="control-label col-lg-2">Tunai</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="tunai" name="tunai" value="<?php echo $tunai; ?>"  minlength="2" type="text" required onkeyup="das();"/> 
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="kembali" class="control-label col-lg-2">Kembalian</label>
                                          <div class="col-lg-10">
                                            <input class="form-control" id="kembali" name="kembali" value="<?php echo $kembali; ?>"  minlength="2" type="text"   required/> 
                                          </div>
                                      </div>
