...
*/
// ------------------------------------------------------------------------
class Stokopnameobat extends CI_Controller {
	...
	function index(){
		...
		$isi['title'] = "Daftar Penerimaan Obat/Stok Opnam Obat";
		$isi['m1'] = "<i class=icon-home></i>Home";
		$isi['m2'] = "Inventori";
		$isi['m3'] = "Obat/Produk";
		$isi['m4'] = "Daftar Stok Opname Obat/Produk";
		$isi['fill'] = "inventori/obat/stokopnameobat/vstokopnameobat";
		//$isi['kodeunik'] = $this->master_model->buat_kode();
		$isi['data'] = $this->master_model->get_stokopnameobat();
